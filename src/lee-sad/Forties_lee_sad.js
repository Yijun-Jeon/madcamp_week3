        ...
        <div className="row">
          ...
          <div className="col__3">
            <div className="service__box pointer">
              ...
              <div className="service__meta">
                <h1 className="service__text">Do Nothing</h1>
                <p className="p service__text p__color">sleeping sleeping</p>
                <p className="p service__text p__color">eating eating</p>
                <p className="p service__text p__color">coding coding</p>
              </div>
          ...
          <div className="col__3">
            <div className="service__box pointer">
              ...
              <div className="service__meta">
                <h1 className="service__text">LOL</h1>
                <p className="p service__text p__color">sleeping sleeping</p>
                <p className="p service__text p__color">eating eating</p>
                <p className="p service__text p__color">coding coding</p>
              </div>
          ...
          <div className="col__3">
            <div className="service__box pointer">
              ...
              <div className="service__meta">
                <h1 className="service__text">Run strategy</h1>
                <p className="p service__text p__color">sleeping sleeping</p>
                <p className="p service__text p__color">eating eating</p>
                <p className="p service__text p__color">coding coding</p>
              </div>
          ...
          <div className="col__3">
            <div className="service__box pointer">
              ...
              <div className="service__meta">
                <h1 className="service__text">Breathing</h1>
                <p className="p service__text p__color">sleeping sleeping</p>
                <p className="p service__text p__color">eating eating</p>
                <p className="p service__text p__color">coding coding</p>
              </div>
          ...
          <div className="col__3">
            <div className="service__box pointer">
              ...
              <div className="service__meta">
                <h1 className="service__text">Blame</h1>
                <p className="p service__text p__color">sleeping sleeping</p>
                <p className="p service__text p__color">eating eating</p>
                <p className="p service__text p__color">coding coding</p>
              </div>
